...
import { Injectable, Compiler, OpaqueToken, Inject } from '@angular/core';
export var RESOLVED_LAB = new OpaqueToken('Resolved Lab');
export var ExperimentFactoryService = (function () {
    ...
    ExperimentFactoryService = __decorate([
        Injectable(),
        __param(0, Inject(RESOLVED_LAB)), 
        __metadata('design:paramtypes', [Object, Compiler])
    ], ExperimentFactoryService);
    return ExperimentFactoryService;
}());
export function provideResolvedLab(lab) {
    return { provide: RESOLVED_LAB, useValue: lab };
}
//# sourceMappingURL=experiment-factory.js.map